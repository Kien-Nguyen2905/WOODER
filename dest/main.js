...
function backToTop(e) {
  let btt = document.querySelector(".footer__btt"),
...
const lang = document.querySelector(".header__lang"),
  langSelect = document.querySelectorAll(".header__lang-select a"),
  langSpan = document.querySelector(".header__lang .header__lang-check span");
...
navigattion();
// Section
let menu = document.querySelectorAll(".header .header__menu a");
let headerScroll = document.querySelector(".header").offsetHeight;
let sections = [];
